...
The completed vertical missions are [M000 executable specification spine](design-specs/M000-executable-specification-spine.md), [M001 refined domain value](design-specs/M001-refined-domain-value.md), [M002 one theory and one finite model](design-specs/M002-one-theory-one-model.md), [M003 generated algebraic law suite](design-specs/M003-generated-law-suite.md), [M004 state transition and invariant preservation](design-specs/M004-state-transition-invariant.md), [M005 two related theories](design-specs/M005-two-related-theories.md), [M005A first useful Core dogfood](design-specs/M005A-first-core-dogfood.md), and [M006 effectful capability boundary](design-specs/M006-effectful-capability-boundary.md). The [capability dependency map](CAPABILITIES.md) records the current route and the unscheduled ADLC-OS north-star pressure test without treating unexercised architecture as settled.
...
The current demonstrations decode a Core service, a refined `Balance`, a finite Account Lifecycle model, an integer-addition law, an Account state machine, an Account/Ledger theory bridge, BANG's own recursive `BridgeTerm`, and an effectful withdrawal realization requiring debit authority. They reject invalid declarations and illegal transition inputs; generate Effect boundaries and property suites; distinguish typed rejection from implementation defects; return finite, algebraic, invariant-preservation, cross-theory, and decoder-drift counterexamples; and write scoped evidence manifests under `.bang/evidence/`.
