...
| objective-relative realization planning  | Select one warranted realization, preserve explicit incomparable plans, or report a typed no-plan result from fresh qualification evidence | realization classification + project composition + local theory package + fresh qualification                   | M032         | complete |
