...
const generatedPath = "generated/effect/BridgeTerm.ts";
const snapshotPath = "tests/snapshots/M005A-BridgeTerm.ts";
...
const program = Effect.scoped(
  Effect.gen(function* () {
    ...
    const source = yield* projectEffectData(checked, "BridgeTerm");
    ...
    if (generated !== snapshot) {
      return yield* new PreparationError({
        message: `generated data kit differs from ${snapshotPath}`,
      });
    }
  }),
);
